...
import type { KnowledgeSource } from "~/stores/question-store";

export interface QaBubbleProps {
  content: string;
  role: "user" | "assistant";
  timestamp: number;
...
export const QaBubble = component$<QaBubbleProps>(({ content, role, timestamp, sources, class: className }) => {
